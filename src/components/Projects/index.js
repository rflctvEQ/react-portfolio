                            ...
                            <figure className="col-10 col-md-4 col-lg-3 project project1">
                                <div className="description">
                                    ...
                                    <div className="link-buttons">
                                        <a href="https://github.com/rflctvEQ/laughing-broccoli" target="_blank" className="github-link">GitHub Repo</a>
                                        <a href="https://calm-oasis-15641.herokuapp.com/" target="_blank" className="project-link">Visit Site</a>
                                    </div>
                                </div>
                            </figure>
                        ...
                        >
                            ...
                            <figure className="col-10 col-md-4 col-lg-3 project project6">
                                <div className="description">
                                    ...
                                    <p>React/JavaScript app that renders a searchable and sortable employee directory from the Random User API.</p>
                                    <div className="link-buttons">
